...
time.sleep(1)
# set google api key and db_host
...
pailie_1 = ['Trip_id', 'Trip_start_timestamp', 'Trip_end_timestamp', 'Pickup_centroid_latitude', 'Pickup_centroid_longitude', 
            'Dropoff_centroid_latitude', 'Dropoff_centroid_longitude', 'Pickup_zipcode', 'Dropoff_zipcode']
# insert into postgre
pre_id = 1
insert_list = []
...
for i in tqdm(content_list_after_delete):
    try:
        ...
        continue
# insert into postgre
pailie_1 = ['Trip_id', 'Trip_start_timestamp', 'Trip_end_timestamp', 'Pickup_centroid_latitude', 'Pickup_centroid_longitude', 'Dropoff_centroid_latitude', 'Dropoff_centroid_longitude', 'Pickup_zipcode', 'Dropoff_zipcode']
# insert into postgre
pre_id = 1
insert_list = []
for j in content_list_after_zipcode:
...
for i in tqdm(content_list_after_delete):
    try:
        ...
        continue
# insert into postgre
pailie_1 = ['permit_id', 'permit_type', 'total_fee', 'latitude', 'longitude', 'zipcode']
...
# insert into postgre
pailie_1 = ['community_area_name', 'below_poverty_level', 'per_capita_income ', 'unemployment']
# insert into postgre
pre_id = 1
insert_list = []
for j in content_list_after_zipcode:
...
content_list_after_zipcode = content_list_after_delete
# insert into postgre
pailie_1 = ['lab_report_date', 'cases_total', 'deaths_total ']
...
content_list_after_zipcode = content_list_after_delete
# insert into postgre
pailie_1 = ['zip_code', 'week_number', 'week_start', 'week_end', 'cases_weekly', 'cases_cumulative']
...
content_list_after_zipcode = content_list_after_delete
# insert into postgre
pailie_1 = ['community_area_name', 'ccvi_score', 'ccvi_category']
